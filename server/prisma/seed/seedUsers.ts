...
export default async function seedUsers(prisma: PrismaClient): Promise<Users> {
    ...
    return { alice, bob, charles, diana, evan, fred, george, helen, liam, lucas, isak, elin, ellen, elinor, ingrid, hilding, vera, felix, linn, thore, rebekka, robert, julia, mathias, elisabeth, maria };
}
